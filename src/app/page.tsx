...
import withLockdown from "./withLockdown";
// import Lockdown from "./Lockdown";
import dynamic from "next/dynamic";

const LockdownNoSsr = dynamic(() => import('./Lockdown'), { ssr: false })

const MyComponentWithLockdown = withLockdown(LockdownNoSsr);
